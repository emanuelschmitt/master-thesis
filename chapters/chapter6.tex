...
\begin{figure}
  ...
  \end{tabular}
  \caption{The pie charts show the distribution of the input modalities and the body postures using in the field and the laboratory trials.}\label{fig:bpimdis}
\end{figure}
