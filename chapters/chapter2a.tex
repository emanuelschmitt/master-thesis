...
A neuron is fundamental processing unit of an artificial neural network. The diagram \label{fig:neuron} shows a model \cite{Haykin:1998:NNC:521706} of a neuron which will be explained in the following:
\begin{itemize}
